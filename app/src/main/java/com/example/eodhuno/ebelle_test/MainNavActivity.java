...
public class MainNavActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_view_appointment) {
            ...
            fragment = new ViewEmployeesFragment();

        } else if (id == R.id.nav_add_employee) {
            fragment = new AddEmployeeFragement();
        ...
        if(fragment != null){
            ...
            fragmentTransaction.replace(R.id.mainScreenContainer,fragment);
